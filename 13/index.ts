...
let transportFav : Array <[transport: string, Model: string, company:String]> = []
...
transportFav.forEach(([transport, model, company]) =>
{console.log(` I would like to buy ${company} ${transport} ${model}.`)}
)
// done